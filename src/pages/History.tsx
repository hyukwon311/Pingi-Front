...
const mockHistory: Session[] = [
  ...
  },
  {
    ...
    status: 'finished',
    participants: [
      { user: { id: '1', nickname: '나' }, drunkLevel: 2, drinkCount: 4, baselineCompleted: true, levelHistory: [] },
      { user: { id: '3', nickname: '동기1' }, drunkLevel: 4, drinkCount: 7, baselineCompleted: true, levelHistory: [] },
      { user: { id: '4', nickname: '동기2' }, drunkLevel: 1, drinkCount: 2, baselineCompleted: true, levelHistory: [] },
    ],
  ...
  },
  {
    ...
    status: 'finished',
    participants: [
      { user: { id: '1', nickname: '나' }, drunkLevel: 1, drinkCount: 1, baselineCompleted: true, levelHistory: [] },
      { user: { id: '5', nickname: '팀장' }, drunkLevel: 3, drinkCount: 6, baselineCompleted: true, levelHistory: [] },
    ],
